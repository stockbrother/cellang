...
import org.cellang.elastictable.Interceptor;
 ...
 * 
 */
public abstract class OperationSupport<O extends TableOperation<O, T>, T extends ExecuteResult<T, ?>>
		implements TableOperation<O, T> {
	...
	protected TableService getDataService() {
