...
curl -XGET 'http://localhost:9200/nodes/mockNode/_search?pretty=true' -d '
{
  ...
  "explain" : true
	...
	public void testQueryByMatch() {
		...
		mn1.setProperty(MockObject.FIELD3, "value13 and value131 value132 value133");
		mn1.save(true);
		...
		mn2.setProperty(MockObject.FIELD3, "value23 and value231 value232 value233");
		mn2.save(true);

		NodeSearchOperationI<MockObject> qo = this.datas.prepareNodeSearch(MockObject.class);
		qo.propertyMatch(MockObject.FIELD3, "value13 value132");
