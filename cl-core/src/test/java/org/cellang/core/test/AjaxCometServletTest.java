...
import org.cellang.core.test.mock.ClientWithBrowserMock;
...
public class AjaxCometServletTest extends TestCase {
	...
	public void testNoThisHandler() throws Exception {
		...
		try {
			...
			Assert.assertEquals("message not expected.", TestAjaxCometServlet.MSG_RESPONSE_no_handler_found,
	...
	public void testHeartBeatAndLongConnection() throws Exception {
		...
		try {
			...
			Comet cmt = TestAjaxCometServlet.ME.getComet(sessionId);
