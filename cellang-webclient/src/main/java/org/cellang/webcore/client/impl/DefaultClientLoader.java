...
public class DefaultClientLoader extends ClientLoader {
	...
	private static Map<String, ImplementerFactory> CACHE = new HashMap<String, ImplementerFactory>();
	...
	@Override
	public ImplementerFactory getOrLoadClient(Implementer[] spis, EventHandlerI<Event> l) {
		...
		ImplementerFactory rt = CACHE.get(key);
		if (rt != null) {
			return rt;
		}
	...
	@Override
	public ImplementerFactory loadClient(Implementer[] spis, EventHandlerI<Event> l) {

		ImplementerFactory factory = ImplementerFactory.create();
